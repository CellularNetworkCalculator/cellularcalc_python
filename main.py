...
print(" підказка: якщо в подальшому розділі ви не введете всі запитувані змінні то програма ")
...
input()
print(" підказка: якщо хочете відразу зробити тестовий розрахунок то в першому ж полі натисніть 'Enter' ")
input(" -------------------------------------------------------------")
...
P_bs = float(f"{Gain_ms - G_bs + 70 + 26.16 * math.log10(F_round) - 13.82 * math.log10(H_bs) + (45 - 6.55 * math.log10(H_bs)) * math.log10(R0):.2f}")
